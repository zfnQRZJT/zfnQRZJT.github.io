...
So with <m>f(1 - \\frac{n}{2^{x}})</m> we do this division x - y times to get <m>${frac(1,"2^<s>x - y</s>"}f(1 - ${frac("n","2<s>y</s>")}) = ${frac(frac("n","2<s>y</s>") + " - 1","2<s>x - y</s>")} = ${frac("n - 2<s>y</s>","2<s>x</s>")}</m>.<br><br><br>\
